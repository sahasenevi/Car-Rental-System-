...
<div class="container mx-auto px-6 py-12 flex justify-center">
    <form action="delete" method="POST" class="bg-white p-10 rounded-3xl shadow-xl max-w-lg w-full space-y-6 border border-gray-100">
        ...
        <div>
            ...
            <input type="text" name="AdminId" value="<%= id %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <label class="block text-gray-700 mb-2">Name</label>
            <input type="text" name="name" value="<%= name %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <label class="block text-gray-700 mb-2">Email</label>
            <input type="email" name="email" value="<%= email %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <label class="block text-gray-700 mb-2">Phone Number</label>
            <input type="text" name="phone" value="<%= phone %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <label class="block text-gray-700 mb-2">User Name</label>
            <input type="text" name="uname" value="<%= userName %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <label class="block text-gray-700 mb-2">Password</label>
            <input type="password" name="pass" value="<%= password %>" readonly class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300" />
        </div>

        <div>
            <input type="submit" name="submit" value="Delete My Account" class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-2 rounded-lg shadow-md transition duration-300 cursor-pointer" />
        </div>
    </form>
</div>
