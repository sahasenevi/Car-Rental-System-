...
<!-- Insert Admin Form -->
<div class="container mx-auto px-6 py-12 flex justify-center items-center">
    <div class="bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full space-y-6 border border-gray-100">
        <h2 class="text-3xl font-extrabold text-center text-gray-800">Create Admin</h2>
        ...
        <form action="insert" method="POST" class="space-y-4">
            ...
            <div>
                <button type="submit" name="submit" value="Create Admin" 
                        class="w-full bg-gradient-to-r from-green-400 to-green-600 text-white py-3 rounded-xl font-semibold hover:from-green-500 hover:to-green-700 transition transform hover:scale-105 duration-300">
                    Submit
                </button>
            </div>
        </form>
